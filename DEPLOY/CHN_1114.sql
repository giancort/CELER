...
------------------------------------------------------------------------------------------                      
	...
	Caike Uchoa                 V8          2020-10-13      Reprocessar relat�rios
...
--------------------------------------
UPDATE COMMERCIAL_ESTABLISHMENT SET STATE_REGISTRATION = 'ISENTO' WHERE STATE_REGISTRATION = 'SP - São Paulo'
GO
UPDATE AFFILIATOR SET STATE_REGISTRATION = 'ISENTO' WHERE STATE_REGISTRATION = 'SP - São Paulo'
GO
