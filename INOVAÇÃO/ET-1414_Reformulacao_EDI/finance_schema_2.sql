...
BEGIN
ALTER TABLE TRANSACTION_TITLES
	ADD COD_ASS_CONC_RESUME INT FOREIGN KEY REFERENCES ASSIGNED_CONCILIATE_RESUME (COD_ASS_CONC_RESUME);END
...
JOIN @TP_CODE TP_CODE
	ON TP_CODE.CODE = PROCESSING_SEND_RECEIVABLE_UNITS.ExternalReference
