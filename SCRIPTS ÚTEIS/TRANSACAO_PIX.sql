...
EXEC SP_VALIDATE_PIX_TRANSACTION @TERMINALID = @COD_EQUIP
							--,@TYPETRANSACTION = @TYPE_TRAN
							,@AMOUNT = 0.15
							--,@QTY_PLOTS = 1
							,@PAN = '64***6565'
							--,@BRAND = @BRAND
							,@TRCODE = '159310791000015'
							,@TERMINALDATE = NULL
...
EXEC SP_FD_PIX_TRAN_INFO '159310791000010'
EXEC SP_FD_PIX_TRAN_INFO '159310791000012'
EXEC SP_FD_PIX_TRAN_INFO '159310791000015'